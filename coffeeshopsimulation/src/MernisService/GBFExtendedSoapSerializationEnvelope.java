...
public class GBFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GBFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GBFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GBFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GBFDateTimeConverter dateTimeConverter = new GBFStandardDateTimeConverter();

    public GBFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GBFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GBFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GBFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GBFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GBFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
