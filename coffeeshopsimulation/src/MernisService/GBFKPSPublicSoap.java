...
public class GBFKPSPublicSoap
{
    ...
    public GBFKPSPublicSoap(){}

    public GBFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GBFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GBFExtendedSoapSerializationEnvelope envelope= new GBFExtendedSoapSerializationEnvelope(GBFExtendedSoapSerializationEnvelope.VER11);
